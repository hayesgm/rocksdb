...
public class WriteBatchWithIndex extends AbstractWriteBatch {
  ...
  public RocksIterator newIteratorWithBase(final ColumnFamilyHandle columnFamilyHandle,
    ...
    final RocksIterator iterator = new RocksIterator(baseIterator.parent_,
        iteratorWithBase(nativeHandle_, baseIterator.parent_.nativeHandle_,
            columnFamilyHandle.nativeHandle_, baseIterator.nativeHandle_,
  ...
  private native long iteratorWithBase(final long handle, final long dbHandle,
      final long baseIteratorHandle, final long cfHandle, final long readOptionsHandle);
