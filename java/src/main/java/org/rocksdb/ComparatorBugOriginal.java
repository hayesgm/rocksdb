...
public class ComparatorBugOriginal {
    static {
        RocksDB.loadLibrary();
    }
    ...
    public static void main(String[] args) {
        ...
        try(RocksDB rocksdb = RocksDB.open(dbOptions, "test-original", columnFamilyDescriptors, columnFamilyHandles)) {
    ...
    private static class VersionedComparator extends AbstractComparator {
